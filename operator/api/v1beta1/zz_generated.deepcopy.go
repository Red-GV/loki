...
func (in *AutoscalingSpec) DeepCopyInto(out *AutoscalingSpec) {
	*out = *in
	if in.HorizontalAutoscaling != nil {
		...
		*out = new(HorizontalAutoscalingSpec)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscalingTemplateSpec) DeepCopyInto(out *AutoscalingTemplateSpec) {
	*out = *in
	if in.GatewayAutoscaling != nil {
		in, out := &in.GatewayAutoscaling, &out.GatewayAutoscaling
		*out = new(AutoscalingSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.IngestionAutoscaling != nil {
		in, out := &in.IngestionAutoscaling, &out.IngestionAutoscaling
		*out = new(AutoscalingSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.QueryAutoscaling != nil {
		in, out := &in.QueryAutoscaling, &out.QueryAutoscaling
		*out = new(AutoscalingSpec)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoscalingTemplateSpec.
func (in *AutoscalingTemplateSpec) DeepCopy() *AutoscalingTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(AutoscalingTemplateSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HorizontalAutoscalingSpec) DeepCopyInto(out *HorizontalAutoscalingSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HorizontalAutoscalingSpec.
func (in *HorizontalAutoscalingSpec) DeepCopy() *HorizontalAutoscalingSpec {
	if in == nil {
		return nil
	}
	out := new(HorizontalAutoscalingSpec)
